...
export function Settings() {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
                <label className="block">Microbreak Interval (s):
                    <input
                        type="number"
            ...
            <div>
                <label className="block">Microbreak Duration (s):
                    <input
                        type="number"
            ...
            <div>
                <label className="inline-flex items-center">
                    <input
                        type="checkbox"
                        name="microbreak_enabled"
                        checked={config.microbreak_enabled}
                        onChange={handleChange}
                        className="mr-2"
                    />
                    Enable Microbreaks
            ...
            <div>
                <label className="block">Rest Interval (s):
                    <input
                        type="number"
                        name="rest_interval"
            ...
            <div>
                <label className="block">Rest Duration (s):
                    <input
                        type="number"
                        name="rest_duration"
            ...
            <div>
                <label className="block">Daily Limit (s):
                    <input
                        type="number"
                        name="daily_limit"
            ...
            <div>
                <label className="block">Warning Duration (s):
                    <input
                        type="number"
